...
#define USART3_PCLK_EN()   (RCC->APB1ENR |= RCC_APB1ENR_USART3EN)
#define UART4_PCLK_EN()    (RCC->APB1ENR |= RCC_APB1ENR_UART4EN)
#define UART5_PCLK_EN()    (RCC->APB1ENR |= RCC_APB1ENR_UART5EN)
...
#define USART3_PCLK_DI()   (RCC->APB1ENR &= ~(RCC_APB1ENR_USART3EN))
#define UART4_PCLK_DI()    (RCC->APB1ENR &= ~(RCC_APB1ENR_UART4EN))
#define UART5_PCLK_DI()    (RCC->APB1ENR &= ~(RCC_APB1ENR_UART5EN))
